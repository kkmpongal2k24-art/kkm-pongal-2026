...
function Expenses({ data, refreshData, currentYear, isLoading = false }) {
  ...
  const filteredExpenses = expenses.filter((expense) => {
    ...
    return (
      ...
      (!expense.category && filterCategory === "Prize")
    ); // Default to Prize for legacy data
  });
  ...
  const prizeExpenses = expenses
    .filter((e) => e.category === "Prize" || !e.category)
  ...
  return (
    <div className="space-y-6 lg:space-y-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">
                        {expenses.filter((e) => e.category === "Other").length}{" "}
                        item
          ...
          >
            <div className="flex items-center gap-2">
              ...
              {filterCategory === "all"
                ...
                : `Add ${
                    filterCategory === "Prize" ? "Prize" : "Other Expense"
                  }`}
            </div>
          </button>
        )}
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-red-700 text-sm">
                Your expenses exceed the collected funds by ₹
                {Math.abs(remainingBalance).toLocaleString()}. Consider
                collecting more funds or reducing expenses.
              </p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="px-6 py-12 text-center">
            ...
            <p className="text-gray-500 mb-4">
              Start by adding your first expense or purchase.
            </p>
      ...
      {viewingExpenseId &&
        (() => {
          const viewingExpense = expenses.find(
            (e) => e.id === viewingExpenseId
          );
          if (!viewingExpense) {
            setViewingExpenseId(null);
            return null;
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-700">
            ...
            <span className="font-semibold">{expenseToDelete?.item}</span>? This
